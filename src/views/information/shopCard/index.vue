  ...
  <div class="app-container">
    ...
    <el-row :gutter="15">
      ...
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="17" style="margin-bottom: 10px">
        <el-card class="box-card" shadow="never">
          <div slot="header" class="clearfix">
            <span class="role-span">购物卡列表</span>
          </div>
          <el-table ref="table" v-loading="crud.loading" highlight-current-row style="width: 100%;" :data="crud.data" @selection-change="crud.selectionChangeHandler" @current-change="handleCurrentChange">
            <el-table-column :selectable="checkboxT" type="selection" width="55" />
            <el-table-column v-if="columns.visible('shopCardId')" prop="shopCardId" label="购物卡ID" />
            <el-table-column v-if="columns.visible('shopCardAccount')" prop="shopCardAccount" label="购物卡ID" />
            <el-table-column v-if="columns.visible('initAmount')" prop="initAmount" label="初始金额" />
      ...
      <el-col :xs="24" :sm="24" :md="8" :lg="8" :xl="7">
        <el-card class="box-card" shadow="never">
          <div slot="header" class="clearfix">
            <el-tooltip class="item" effect="dark" content="选择指定下单人分配购物卡" placement="top">
              <span class="role-span">购物卡分配</span>
            </el-tooltip>
            <el-button
...
import crudShopCards from '@/api/information/shopCard'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '购物卡', url: 'api/shopCard/allocation', sort: 'updateTime', crudMethod: { ...crudShopCards }})
