    ...
    >
      ...
      >
        <el-row type="flex" class="row-bg">
          ...
          <el-col :span="12">
            <el-form-item label="是否反馈下单" prop="isFeedback">
              <el-select
                v-model="form.isFeedback"
                prop="isFeedback"
                clearable
                placeholder="请选择"
                style="width: 200px;"
        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="是否签收" prop="isSigned">
              <el-select
          ...
          <el-col :span="12">
            <el-form-item label="签收截图" prop="signedJtUrl">
              <img id="signedJtUrl" :src="form.signedJtUrl" style="height: 80px; width: 200px" alt />
