    ...
    >
      ...
      >
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="卖家微信/QQ" prop="sellerContactType">
              <div style="width: 200px;">{{form.sellerContactType}}【{{form.sellerOrderType}}】</div>
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="店铺名" prop="mktName">
              <div style="width: 200px;">{{form.mktName}}</div>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="商品图片" prop="goodImgUrl">
              <el-image
                :src="form.goodImgUrl"
                :preview-src-list="[form.goodImgUrl]"
                fit="contain"
                lazy
                class="el-avatar"
            ...
            <el-row type="flex" class="row-bg">
              <el-form-item label="Asin" prop="asin">
                <div style="width: 200px;">
                  <a
                    target="_blank"
                    :href="'http://www.amazon.com/gp/product/'+ form.asin "
                  >{{ form.asin }}</a>
                </div>
              </el-form-item>
            </el-row>
        ...
        <el-row type="flex" class="row-bg">
          <el-form-item label="额外要求" prop="mktName">
            <div
              style="width: 400px;"
            >是否留评:{{form.isComment}},是否换仓:{{form.isComment}},是否回收:{{form.isRecover}}</div>
          </el-form-item>
        </el-row>

        <el-row type="flex" class="row-bg">
          <el-form-item label="下单要求" prop="xdRequirement">
            <div style="width: 400px;">{{form.xdRequirement}}</div>
          </el-form-item>
        </el-row>

        <el-row type="flex" class="row-bg">
          <el-form-item label="备注" prop="remark">
            <div style="width: 400px;">{{form.remark}}</div>
          </el-form-item>
        </el-row>
        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-row type="flex" class="row-bg">
              <el-col :span="12">
                <el-form-item label="支付金额" prop="payPrice">
                  <el-input v-model="form.payPrice" style="width: 200px;" />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row type="flex" class="row-bg">
              <el-col :span="12">
                <el-form-item label="下单人" prop="makeUserName">
                  <el-input v-model="form.makeUserName" style="width: 200px;" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="下单截图" prop="makeJtUrl">
              <img id="makeJtUrl" :src="form.makeJtUrl" style="height: 80px; width: 200px" alt />
        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-row type="flex" class="row-bg">
              <el-col :span="12">
                <el-form-item label="账号id" prop="shopCardId">
                  <el-input v-model="form.shopCardId" style="width: 200px;" />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row type="flex" class="row-bg">
              <el-col :span="12">
                <el-form-item label="下单号" prop="goodOrderNum">
                  <el-input v-model="form.goodOrderNum" style="width: 200px;" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="下单付款截图" prop="makePayedJtUrl">
              <img
                id="makePayedJtUrl"
                :src="form.makePayedJtUrl"
        ...
        <el-row type="flex" class="row-bg">
          <el-form-item label="选择地址" prop="autoAddress">
            <el-input v-model="form.autoAddress" style="width: 600px;" />
          </el-form-item>
        </el-row>

        <el-row type="flex" class="row-bg">
          <el-form-item label="自用地址" prop="selfAddress">
            <el-input v-model="form.selfAddress" style="width: 600px;" />
          </el-form-item>
        </el-row>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button :loading="crud.status.cu === 2" type="primary" @click="submit(form)">确认</el-button>
      </div>
    </el-dialog>
    <!--表格渲染-->
    <el-table
...
export default {
  ...
  methods: {
    ...
    makeOrder(data) {
      ...
      this.crud.getDataStatus(data.id).edit = CRUD.STATUS.PREPARED
