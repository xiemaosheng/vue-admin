       ...
       <el-row type="flex" class="row-bg">
        ...
        <el-row type="flex" class="row-bg">
          ...
          <el-col :span="12">
            ...
            <el-row type="flex" class="row-bg">
              <el-form-item label="是否反馈上评" prop="isFeedbackReview">
              <el-select
                v-model="form.isFeedbackReview"
                prop="isFeedbackReview"
                clearable
                placeholder="请选择"
                style="width: 200px;"
              >
            ...
            <el-row type="flex" class="row-bg">
              <el-form-item label="是否可上评" prop="isFeedbackReview">
              <el-select
                v-model="form.isFeedbackReview"
                prop="isFeedbackReview"
                clearable
        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="是否上评" prop="isFeedbackReview">
              <el-select
                v-model="form.isFeedbackReview"
                prop="isFeedbackReview"
                clearable
          ...
          <el-col :span="12">
            <el-form-item label="评论链接" prop="reviewLinkUrl">
              <el-input v-model="form.reviewLinkUrl" style="width: 200px;" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="追踪号" prop="trackNo">
              <el-input v-model="form.trackNo" style="width: 200px;" />
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="上评账号" prop="reviewUserName">
              <el-input v-model="form.reviewUserName" style="width: 200px;" />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="评论截图" prop="reviewJtUrl">
              <img id="reviewJtUrl" :src="form.reviewJtUrl" style="height: 80px; width: 200px" alt />
              <el-button type="text" @click="paster(1)">粘贴</el-button>
            </el-form-item>
          </el-col>

          <el-col :span="12">
            <el-form-item label="feedBack截图" prop="reviewJtUrl">
              <img id="reviewJtUrl" :src="form.reviewJtUrl" style="height: 80px; width: 200px" alt />
              <el-button type="text" @click="paster(1)">粘贴</el-button>
            </el-form-item>
          </el-col>
