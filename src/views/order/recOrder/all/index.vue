        ...
        <el-row type="flex" class="row-bg">
          <el-col :span="12">
            <el-form-item label="商品图片" prop="goodImgUrl">
              ...
              <el-button ref="pasterButton" type="text" @click="paster(1)" style="display: block">粘贴</el-button>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-row type="flex" class="row-bg">
...
export default {
  name: "RecAll",
  components: { Detail,crudFile, pagination, crudOperation, rrOperation },
  ...
  methods: {
    ...
    uploadImg(name, data) {
      ...
      crudFile.add(param).then(response => {
        ...
        defaultCrud.form.goodImgUrl = url;
        console.log("form:" + JSON.stringify(defaultCrud.form.goodImgUrl));
      });
      return url;
    },
    handlePaste(event) {
      ...
      reader.onload = event => {
        ...
        this.$refs.pasterButton.style.display = "none";
      };
